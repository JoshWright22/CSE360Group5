...
public class UserHomePage {
	...
	private void showScene(Stage primaryStage) {
		...
		postButton.setOnAction(e -> {
			Question question = StartCSE360.getQuestionManager().createNewQuestion(currentUser.getUserName(),
					LocalDateTime.now(), titleTextArea.getText(), bodyTextArea.getText(), new ArrayList<String>());
	...
	private void setQuestionLabelStyle(Label questionLabel) {
		questionLabel.setStyle("-fx-font-size: 18px;" + "-fx-background-color: #f0f0f0; " + "-fx-padding: 10; "
				+ "-fx-background-radius: 5; " + "-fx-border-color: transparent; " + "-fx-border-radius: 5;");

		questionLabel.setOnMouseEntered(
				f -> questionLabel.setStyle("-fx-font-size: 18px;" + "-fx-background-color: #f0f0f0; " + "-fx-padding: 10; "
						+ "-fx-background-radius: 5; " + "-fx-border-color: #ADD0F2; " + "-fx-border-radius: 5;"));

		questionLabel.setOnMouseExited(
				f -> questionLabel.setStyle("-fx-font-size: 18px;" + "-fx-background-color: #f0f0f0; " + "-fx-padding: 10; "
						+ "-fx-background-radius: 5; " + "-fx-border-color: transparent; " + "-fx-border-radius: 5;"));
	}
