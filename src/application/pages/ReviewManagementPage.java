...
/**
 * Provides UI for reviewers to view and manage all their reviews.
 * Allows editing and deleting of reviews.
 */
public class ReviewManagementPage {
    ...
    private VBox createStatsSection() {
        ...
        statsBox.getChildren().addAll(
                createStatBox("Total Reviews", String.valueOf(totalReviews)),
    ...
    private VBox createReviewBox(Review review, VBox reviewsListBox, Stage primaryStage, UserHomePage userHomePage) {
        ...
        String targetInfo = review.isQuestionReview()
                ? "Question: " + review.getReviewedQuestion().getTitle()
