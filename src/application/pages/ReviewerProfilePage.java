...
/**
 * Provides UI for reviewers to create and edit their profiles.
 * Displays reviewer expertise, experience, and qualifications.
 */
public class ReviewerProfilePage {
    ...
    private VBox createEditableFieldsBox(ReviewerProfile profile, ReviewerProfileManager profileManager,
            Stage primaryStage, UserHomePage userHomePage) {
