...
public class UserNameRecognizer {
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0:
				...
				if ((currentChar >= 'A' && currentChar <= 'Z') || (currentChar >= 'a' && currentChar <= 'z'))
					isAlphabetical = true;
				if (isAlphabetical) {
					// Input is valid, move to next state
					nextState = 1;
			...
			case 1:
				...
				// . -> State 2
				// Modified to allow for dashes and underscores
		...
		case 2:
			...
			userNameRecognizerErrorMessage += "A UserName character after a period, underscore, or dash must be A-Z, a-z, or 0-9.\n";
			return userNameRecognizerErrorMessage;
